...
```bash
git remote add encore encore://btc-zmw-exchange-3fii
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/btc-zmw-exchange-3fii/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/btc-zmw-exchange-3fii/settings/integrations/github)
